...
describe("video-provider-youku.com", function() {
    ...
    describe("create", function() {
        ...
        it("html format", function() {
            assert.equal(parser.create({
                format: "html",
                provider: "youku.com",
                id: "XMTg3NjAyNzQ2MA=="
            }), "http://v.youku.com/v_show/id_XMTg3NjAyNzQ2MA==.html");
        });
        ...
        it("params", function() {
            ...
            }), "http://v.youku.com/v_show/id_XMTg3NjAyNzQ2MA==.html?from=npm&v=0.1");
        });
    });
});